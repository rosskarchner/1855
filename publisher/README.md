...
This is a sample template for publisher - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name publisher --tail
```
...
```bash
aws cloudformation delete-stack --stack-name publisher
```
