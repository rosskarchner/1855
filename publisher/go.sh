...
sam deploy --template-file deploy.yml  --stack-name blog --capabilities CAPABILITY_IAM\
 --parameter-overrides DomainName=ross.karchner.com  BlogName="Ross Karchner" \
