...
This is a sample template for indieauth - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name indieauth --tail
```
...
```bash
aws cloudformation delete-stack --stack-name indieauth
```
